        ...
        <div className="max-w-screen-2xl container mx-auto md:px-20 px-4 flex flex-col md:flex-row dark:bg-slate-900 dark:text-white ">
            <div className="order-2 md:order-1 w-full md:w-1/2 mt-12 md:mt-32">
                <div className="space-y-12">
                    ...
                    <p className="text-x1">Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
                ...
                <button className="btn btn-secondary mt-6">Verify</button>
            </div>
            <div className=" order-1 w-full md:w-1/2">
                <img className=" h-92 w-92 ml-5 mt-12" src={Bannerimg} alt="" />
            </div>
